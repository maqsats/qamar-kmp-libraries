...
class JsonTransliterationProviderTest {
    ...
    @Test
    fun testGetTransliterationNotFound() = runTest {
    ...
    @Test
    fun testGetSuraTransliterationNotFound() = runTest {
    ...
    @Test
    fun testDifferentLanguages() = runTest {
        // Test that different languages can be loaded
        provider.getTransliteration(1, 1, TransliterationLanguage.ENGLISH)
        provider.getTransliteration(1, 1, TransliterationLanguage.RUSSIAN)
        provider.getTransliteration(1, 1, TransliterationLanguage.KAZAKH)
    ...
    @Test
    fun testGetSuraTransliterationOrder() = runTest {
        val transliterations = provider.getSuraTransliteration(1, TransliterationLanguage.ENGLISH)
